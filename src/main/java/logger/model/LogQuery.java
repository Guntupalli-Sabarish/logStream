...
public class LogQuery {
    ...
    private String search;   // plain string or regex, applied to log.data
    private Long from;       // epoch ms, inclusive
    private Long to;         // epoch ms, inclusive
    private int limit = 500; // max results, 0 = no limit (capped to 500)
